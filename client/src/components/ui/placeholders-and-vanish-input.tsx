...
export function PlaceholdersAndVanishInput({
  ...
  return (
    <form
      className={cn(
        "w-full relative max-w-xl mx-auto h-12 rounded-full overflow-hidden shadow transition duration-200",
        value && "bg-gray-50",
        className
      )}
        ...
        <AnimatePresence mode="wait">
          {!value && (
            <motion.p
              ...
              className={cn(
                "text-sm sm:text-base font-normal text-neutral-500 pl-4 sm:pl-12 text-left w-[calc(100%-2rem)] truncate",
