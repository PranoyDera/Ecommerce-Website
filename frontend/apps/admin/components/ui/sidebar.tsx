...
export const DesktopSidebar = ({
  ...
  return (
    <>
      <motion.div
        className={cn(
          "h-full px-2 py-4 hidden  md:flex md:flex-col bg-neutral-100 dark:bg-neutral-800 w-75 shrink-0",
          className
        )}
        animate={{
...
export const SidebarLink = ({
  ...
  return (
    <button
      ...
      className={cn(
        "flex items-center gap-2 group/sidebar py-2 w-full cursor-pointer",
