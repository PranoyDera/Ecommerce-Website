            ...
            <LabelInputContainer key={field.name}>
              ...
              {field.type === "select" && (
                <select
                  ...
                  className="h-10 w-full rounded-md border border-input bg-background px-3 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white"
                >
              ...
              className={`mt-2 block h-10 w-full rounded-md border border-gray-300 font-medium 
                ${
                  secondaryDisabled
                    ...
                    : "bg-gradient-to-br from-blue-900 to-neutral-600 text-white hover:bg-gray-100 cursor-pointer"
                } 
